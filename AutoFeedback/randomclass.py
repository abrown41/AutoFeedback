...
and {str(self.upper)} with expectation {str(self.expectation)}"
    ...
    def __len__(self):
        ...
        if hasattr(self.expectation, "__len__") : return len(self.expectation)
        return 1

    def _check_for_bad_value(self, val, num):
        """check if the value is within the allowed range for the random variable and (if relevant) 
           it is an integer 
           ...
           num : index of random variable from expectation array or -1 if only one expectation specificd
           """
        if num < 0:
    ...
    def _check_random_var(self, val, num):
        ...
        num : int
              index of expectation array that we are using when testing if this is from correct distribution
        """
    ...
    def get_error(self, obj):
        ...
        ==========
        obj : str
              description of object that is not producing correct random variables
        """
        error_message = ""
